...
rho     = 0.6;      % Persistence of Labour Endowment Shock
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FOR THE CLASS, REDEFINE THIS NAIVE BRACKET TO SAVE TIME
minrate = 0.03; maxrate = 0.04;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     err = abs(maxrate - minrate);
    ...
    disp(['Error |Ks-Kd| = ',num2str(err),', for interest rate = ',num2str(r_g)]);
end
...
plot(Kd,rgrid,'k','LineWidth',2), hold on;
